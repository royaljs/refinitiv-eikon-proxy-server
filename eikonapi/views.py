...
class NewsHeadlineView(APIView):
    ...
    def get(self, request):
        ...
        try:
            ...
            return Response('EikonError!', status=400)    
...
class TimeSeriesDataView(APIView):
    ...
    def get(self, request):
        ...
        # Invalid RIC에 대한 응답
        try:
            result = ek.get_timeseries(instruments, fields, dateFrom, dateTo, interval)
        except ek.eikonError.EikonError:
            return Response('EikonError!-Invalid RIC', status=400)
        # 엑셀 파일 저장
